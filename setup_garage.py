...
def cargar_garaje_masivo():
    with app.app_context():
        ...
        flota = [
            # --- F1 LEYENDAS ---
            {
                "name": "McLaren MP4/4", "year": 1988, "cat": "F1 Legend",
                "desc": """HISTORIA:
...
Ganó 15 de las 16 carreras de la temporada 1988, perdiendo solo en Monza debido a un incidente fortuito. Senna consiguió su primer título mundial con este chasis. Es el estándar de oro contra el que se mide cualquier dominio en la F1.""",
            ...
            {
                "name": "Ferrari F2004", "year": 2004, "cat": "F1 Legend",
...
Este coche fue tan rápido que sus récords de vuelta en circuitos como Monza, Melbourne y Nürburgring se mantuvieron vigentes durante casi 15 años, hasta que los coches modernos de 2018-2020 lograron batirlos con neumáticos mucho más anchos.""",
            ...
            {
                "name": "Williams FW14B", "year": 1992, "cat": "F1 Legend",
...
Fue tan superior (a veces sacaba 2 segundos por vuelta al segundo clasificado) que la FIA terminó prohibiendo todas estas ayudas electrónicas para 1994, convirtiendo al FW14B en el coche tecnológicamente más avanzado de su década.""",
            ...
            {
                "name": "Mercedes W11", "year": 2020, "cat": "F1 Legend",
...
Ganó 13 de 17 carreras en una temporada acortada por la pandemia. Su carga aerodinámica era tal que en curvas como Pouhon (Spa) o Copse (Silverstone) los pilotos ni siquiera levantaban el pie del acelerador.""",
            ...
            # --- RALLY LEYENDAS ---
            {
                "name": "Audi Quattro S1", "year": 1985, "cat": "Rally Monster",
...
Tras la cancelación del Grupo B por su peligrosidad, Walter Röhrl llevó este coche a la famosa subida de Pikes Peak en 1987, convirtiéndose en el primer piloto en bajar de los 11 minutos, un hito histórico.""",
            ...
            {
                "name": "Lancia Stratos HF", "year": 1974, "cat": "Rally Legend",
...
Ganó el título de constructores tres años seguidos (1974, 1975, 1976). Es recordado como uno de los coches más bellos y efectivos jamás creados, apodado 'la bête à gagner' (la bestia para ganar).""",
            ...
            {
                "name": "Subaru Impreza 22B", "year": 1998, "cat": "JDM Icon",
...
Solo se fabricaron 400 unidades para Japón, que se vendieron en menos de 30 minutos. Hoy en día es uno de los coches japoneses más caros y buscados del mundo.""",
            ...
            # --- SUPERCARS ---
            {
                "name": "Ferrari F40", "year": 1987, "cat": "Supercar",
...
Famoso por su entrega de potencia "explosiva". Cuando los dos turbos IHI soplan a máxima presión, el coche se vuelve salvaje, exigiendo el máximo respeto del conductor.""",
            ...
            {
                "name": "Bugatti Veyron", "year": 2005, "cat": "Hypercar",
...
Para superar los 375 km/h, el conductor debe insertar una segunda llave especial en el suelo, que baja la suspensión, cierra los difusores frontales y reduce el ángulo del alerón trasero.""",
            ...
            {
                "name": "Mazda 787B", "year": 1991, "cat": "Le Mans Legend",
...
Poco después de su victoria, la normativa cambió, prohibiendo efectivamente los motores rotativos en la competición principal, lo que convirtió su hazaña en algo irrepetible.""",
            ...
            # --- JDM LEGENDS ---
            {
                "name": "Nissan Skyline GT-R R34", "year": 1999, "cat": "JDM Legend",
                "desc": """GODZILLA:
...
El bloque motor RB26DETT es legendario por su resistencia. Aunque salía de fábrica con "276 CV" (por un pacto de caballeros japonés), en realidad daba más de 330 CV, y con modificaciones básicas podía superar fácilmente los 600 CV.""",
            ...
            {
                "name": "Toyota Supra MK4", "year": 1994, "cat": "JDM Legend",
...
En su versión de stock, era un gran turismo cómodo y rápido, capaz de competir con Porsche y Ferrari de la época por una fracción del precio. Hoy en día, encontrar una unidad totalmente original es casi imposible y valen fortunas.""",
             ...
             {
                "name": "Dodge Viper GTS", "year": 1996, "cat": "Muscle Car",
...
La versión GTS introdujo el techo de "doble burbuja", diseñado para que los pilotos pudieran usar casco cómodamente. Sus franjas blancas sobre pintura azul son una de las decoraciones más icónicas de la historia del automovilismo americano.""",
        ...
        otros_coches = [
             {"n": "Mercedes 300 SL", "y": 1954, "c": "Classic", "hp": 215, "desc": "El 'Alas de Gaviota'. Primer superdeportivo de la historia con inyección directa. Una obra de arte de la ingeniería alemana."},
             {"n": "Aston Martin DB5", "y": 1964, "c": "Classic", "hp": 282, "desc": "El coche de James Bond. Elegancia británica atemporal. Famoso por sus gadgets en la gran pantalla y su clase en la carretera."},
             {"n": "Shelby Cobra 427", "y": 1965, "c": "Muscle", "hp": 425, "desc": "Chasis británico AC Ace con un V8 Ford masivo. La definición de relación peso/potencia absurda. Aceleraba de 0 a 100 más rápido que muchos coches modernos."},
             {"n": "Ford GT40", "y": 1966, "c": "Le Mans", "hp": 485, "desc": "Nacido de la venganza de Ford contra Ferrari. Logró un histórico 1-2-3 en Le Mans 66, rompiendo la hegemonía italiana."},
             {"n": "Porsche 959", "y": 1986, "c": "Supercar", "hp": 450, "desc": "El coche más tecnológico de los 80. Introdujo el sistema de tracción total moderno y suspensión adaptativa. Originalmente pensado para el Grupo B."},
             {"n": "Honda NSX-R", "y": 1992, "c": "JDM", "hp": 280, "desc": "Puesto a punto por Ayrton Senna. El primer superdeportivo de aluminio fiable y utilizable a diario. Cambió el estándar de calidad de Ferrari y Lamborghini."},
             {"n": "Lexus LFA", "y": 2010, "c": "Supercar", "hp": 560, "desc": "Una obra maestra de fibra de carbono que tardó 10 años en desarrollarse. Su motor V10 Yamaha sube de vueltas tan rápido que necesita un tacómetro digital."},
             {"n": "Pagani Zonda", "y": 1999, "c": "Hypercar", "hp": 555, "desc": "El sueño de Horacio Pagani. Artesanía italiana con corazón Mercedes AMG. Cada tornillo es una pieza de joyería."},
             {"n": "Koenigsegg Agera RS", "y": 2015, "c": "Hypercar", "hp": 1160, "desc": "El coche que batió el récord de velocidad en carretera pública en Nevada (447 km/h). Ingeniería sueca sin compromisos."},
             {"n": "Lamborghini Countach", "y": 1974, "c": "Classic", "hp": 375, "desc": "El diseño de cuña que definió los años 70 y 80. Sus puertas de tijera y su forma extrema lo convirtieron en el póster de habitación de toda una generación."},
             {"n": "Lamborghini Miura", "y": 1966, "c": "Classic", "hp": 350, "desc": "El padre de los superdeportivos modernos. Fue el primero en colocar el motor V12 en posición central trasera. Bellísimo y peligroso."},
             {"n": "Jaguar E-Type", "y": 1961, "c": "Classic", "hp": 265, "desc": "Enzo Ferrari lo llamó 'el coche más bello del mundo'. Un icono de los años 60 que combinaba altas prestaciones con un precio accesible."},
             {"n": "Toyota 2000GT", "y": 1967, "c": "Classic", "hp": 150, "desc": "El primer supercoche japonés. Desarrollado con Yamaha, demostró al mundo que Japón podía hacer coches deportivos de clase mundial."},
             {"n": "BMW M3 E30", "y": 1986, "c": "Classic", "hp": 200, "desc": "Nacido para homologar el coche de carreras del DTM. Es considerado uno de los mejores chasis de la historia por su equilibrio y pureza."},
             {"n": "Porsche Carrera GT", "y": 2004, "c": "Supercar", "hp": 612, "desc": "Motor V10 derivado de la F1, cambio manual y embrague cerámico. Uno de los últimos superdeportivos analógicos verdaderos."},
             {"n": "Ferrari LaFerrari", "y": 2013, "c": "Hypercar", "hp": 963, "desc": "El primer híbrido de Ferrari. Parte de la 'Santa Trinidad'. Usa tecnología KERS de la F1 para apoyar a su V12 atmosférico."},
             {"n": "McLaren F1", "y": 1992, "c": "Supercar", "hp": 627, "desc": "El coche más rápido del mundo durante una década. Asiento central, motor BMW V12 recubierto de oro. La perfección técnica."},
             {"n": "Alfa Romeo 33 Stradale", "y": 1967, "c": "Classic", "hp": 230, "desc": "Posiblemente el coche más bonito jamás dibujado. Un coche de carreras matriculable, curvoso, pequeño y extremadamente caro en su época."},
             {"n": "Lancia Delta Integrale", "y": 1991, "c": "Rally", "hp": 215, "desc": "La evolución final del coche más exitoso del WRC. Ensanchado, turboalimentado y con tracción total. Un icono italiano."},
             {"n": "Peugeot 205 T16", "y": 1984, "c": "Rally", "hp": 200, "desc": "Motor central y tracción total en un cuerpo que parecía un utilitario. La base del coche que dominó el Grupo B y el Dakar."},
             {"n": "Ford Escort Cosworth", "y": 1992, "c": "Rally", "hp": 227, "desc": "Famoso por su alerón 'cola de ballena'. Era un coche de rally del Grupo A disfrazado de coche de calle."},
             {"n": "Mitsubishi Evo VI", "y": 1999, "c": "JDM", "hp": 280, "desc": "La edición Tommi Mäkinen. Tracción total avanzada y una agilidad increíble en cualquier terreno."},
             {"n": "Renault 5 Turbo", "y": 1980, "c": "Rally", "hp": 160, "desc": "Renault cogió su coche urbano, le puso el motor en el asiento de atrás y lo ensanchó desproporcionadamente. Una locura genial."},
             {"n": "Alpine A110", "y": 1971, "c": "Rally", "hp": 140, "desc": "La Berlinette. Pequeño, ligero y ágil. Dominó los primeros años del campeonato internacional de rallys."},
             {"n": "Lotus Elise S1", "y": 1996, "c": "Sport", "hp": 118, "desc": "'Menos es más'. Chasis de aluminio pegado, peso pluma (725kg). Ofrece una conexión con la carretera que pocos coches igualan."},
             {"n": "Mazda MX-5 NA", "y": 1989, "c": "Classic", "hp": 115, "desc": "El coche que salvó a los roadsters. Fiabilidad japonesa con espíritu británico. Faros retráctiles y diversión pura."},
             {"n": "Honda S2000", "y": 1999, "c": "JDM", "hp": 240, "desc": "El regalo de 50 cumpleaños de Honda. Su motor VTEC corta a 9000 rpm, ofreciendo una de las mejores cajas de cambios manuales."},
             {"n": "Toyota AE86", "y": 1983, "c": "JDM", "hp": 130, "desc": "El Hachi-Roku. Leyenda del drift y del anime Initial D. Ligero, tracción trasera y perfecto para aprender a conducir."},
             {"n": "Nissan 240Z", "y": 1969, "c": "Classic", "hp": 150, "desc": "El coche que puso a los deportivos japoneses en el mapa global. Bonito, rápido y fiable. Un clásico instantáneo."},
             {"n": "Chevrolet Corvette C2", "y": 1963, "c": "Muscle", "hp": 360, "desc": "El Sting Ray. Famoso por su ventana trasera partida (Split Window) de 1963. Diseño inspirado en la vida marina."},
             {"n": "Ford Mustang 1967", "y": 1967, "c": "Muscle", "hp": 320, "desc": "El Fastback. Icono de Bullitt. Definió la estética del muscle car americano junto al Camaro."},
             {"n": "Pontiac GTO", "y": 1964, "c": "Muscle", "hp": 325, "desc": "Considerado por muchos el primer Muscle Car. Motor grande en coche mediano a precio bajo. Creó una tendencia."},
             {"n": "Plymouth Superbird", "y": 1970, "c": "Muscle", "hp": 425, "desc": "Diseñado para NASCAR con un alerón trasero gigantesco y morro aerodinámico. Inconfundible y hoy en día muy valioso."},
             {"n": "Mercedes CLK GTR", "y": 1998, "c": "Supercar", "hp": 600, "desc": "Un coche de carreras GT1 que aterrizó en la calle por obligación del reglamento. Extremadamente ancho, bajo y caro."},
             {"n": "Porsche 911 GT1", "y": 1997, "c": "Supercar", "hp": 536, "desc": "La respuesta de Porsche al McLaren F1 y al CLK GTR. Un 911 mutado con motor central para ganar Le Mans."},
             {"n": "Toyota GT-One", "y": 1998, "c": "Le Mans", "hp": 600, "desc": "Diseñado al límite del reglamento. Prácticamente un prototipo pintado de calle. Solo se hicieron 2 unidades de carretera."},
             {"n": "Sauber C9", "y": 1989, "c": "Le Mans", "hp": 720, "desc": "La flecha de plata del Grupo C. Alcanzó los 400 km/h en Mulsanne. Potencia bruta de Mercedes V8 Turbo."},
             {"n": "Jaguar XJ220", "y": 1992, "c": "Supercar", "hp": 542, "desc": "Iba a tener un V12, pero llegó con un V6 Turbo. A pesar de la decepción, fue el coche más rápido del mundo brevemente (342 km/h)."}
        ]
        ...
        for car in flota:
            count += 1
            safe_name = car["name"].lower().replace(" ", "_").replace("-", "_").replace("/", "_") + ".jpg"
            ruta_img = descargar_imagen(car["url"], safe_name)
            marca = car["name"].split(" ")[0]
            
            nuevo = Vehicle(
                name=car["name"], image=ruta_img, description=car["desc"], manufacturer=marca,
                year=car["year"], category=car["cat"], engine=car["engine"], 
                horsepower=car["hp"], top_speed=car["top"], acceleration=car["acc"], weight=car["w"]
            )
...
Este vehículo es un icono de su categoría ({car['c']}) y representa un hito en la ingeniería automotriz del año {car['y']}."""
            ...
            nuevo = Vehicle(
                name=car["n"], image="img/default_car.jpg", description=desc_larga, 
                manufacturer=car["n"].split(" ")[0], year=car["y"], category=car["c"],
                engine="N/A", horsepower=car["hp"], top_speed=0, acceleration=0.0, weight=0
            )
            db.session.add(nuevo)
